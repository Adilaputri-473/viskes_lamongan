    ...
    <div class="wrapper">
            ...
            <div class="visualisasi-section" id="dataCards">
                <div class="main-content">
                    <div class="content-data" id="contentData">
                        <h2 class="text-center">Visualisasi Data Status Kesehatan Ibu dan Anak</h2>

                        <div class="iframe-container mb-4 default-iframe">
                            <h3 class="text-center">Informasi dan Tren Pertahun</h3>
                            <iframe src="http://localhost:3000/public/dashboard/ee98e416-c480-4c9c-a107-399d368397eb" 
                        ...
                        <div id="iframeContainer">
                            @foreach($visualisasi as $data)
                                <div class="iframe-container"
                                    ...
                                    style="display: none;">
                                    <h3 class="text-center">{{ $data->ibu_anak->indikator }} Tahun {{ $data->tahun->tahun }}</h3>
        ...
        <div class="sidebar-kanan-wrapper" id="sidebarKanan">
            <div class="sidebar-kanan">
                ...
                <p>Untuk melihat data berdasarkan tahun dan indikator kesehatan ibu dan anak, atur pilihan pada dropdown berikut:</p>
                ...
                <select id="indikatorSelect" class="form-control">
                    ...
                    @foreach($ibu_anaks as $indikator)
