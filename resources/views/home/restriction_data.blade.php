        ...
        <div class="content-wrapper" style="margin: 0; padding: 0;">
            ...
            <div class="visualisasi-section" id="dataCards">
                <div class="card p-4 fade-in" style="max-width: 800px;">
                    <p class="mb-3">
                        Ingin melihat bagaimana data kesehatan di Kabupaten Lamongan divisualisasikan secara interaktif dan informatif?
                        Akses grafik, tren, dan informasi penting lainnya hanya tersedia untuk pengguna terdaftar.
                    </p>
                    <p class="mb-2">
