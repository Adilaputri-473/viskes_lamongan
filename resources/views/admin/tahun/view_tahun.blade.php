...
<body class="hold-transition sidebar-mini layout-fixed" style="background-color: #f6f6f6;">
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header d-flex align-items-center"
                            ...
                            <h3 class="card-title">Table Tahun</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <button type="button" class="btn btn-block btn-success" style="width:200px; border-radius: 8px;"
                                onclick="window.location.href='{{ url('add_tahun') }}'">
                                <i class="fas fa-plus" style="padding-right: 8px;"></i> Add Tahun
                            </button>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right py-0 align-middle">
                                                    <div class="btn-group btn-group-sm">
                                                        <a href="{{ url('update_tahun', $tahuns->id) }}"
                                                            class="btn btn-info " style="border-radius: 8px; padding-right: 8px;"> 
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <a href="{{ url('delete_tahun', $tahuns->id) }}"
                            ...
                            <div class="form-footer clearfix">
                                   {{ $tahun->appends(request()->input())->links('pagination::bootstrap-4') }}
                            </div>
                        </div>
                        <!-- /.card-body -->
    ...
    <script>
        function confirmation(ev) {
            ...
            var userChoice = confirm("Are you sure you want to delete this Tahun?");
            if (userChoice) {
