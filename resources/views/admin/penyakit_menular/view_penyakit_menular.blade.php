...
<body class="hold-transition sidebar-mini layout-fixed" style="background-color: #f6f6f6;">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Table Penyakit Menular</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Penyakit Menular</a></li>
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header d-flex align-items-center"
                            ...
                            <h3 class="card-title">Table Penyakit Menular</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <button type="button" class="btn btn-block btn-success" style="width:200px; border-radius: 8px;"
                                onclick="window.location.href='{{ url('add_penyakit_menular') }}'">
                                <i class="fas fa-plus" style="padding-right: 8px;"></i> Add Penyakit
                            </button>
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @foreach ($penyakit_menular as $data)
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td>{{ $data->indikator }}</td>
                                                <td class="text-right py-0 align-middle">
                                                    <div class="btn-group btn-group-sm">
                                                        <a href="{{ url('update_penyakit_menular', $data->id) }}"
                                                            class="btn btn-info " style="border-radius: 8px;" title="Edit">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <a href="{{ url('delete_penyakit_menular', $data->id) }}"
                            ...
                            <div class="form-footer clearfix">
                                {{ $penyakit_menular->appends(request()->input())->links('pagination::bootstrap-4') }}
                            </div>
                        </div>
                        <!-- /.card-body -->
    ...
    <script>
        function confirmation(ev) {
            ...
            var userChoice = confirm("Are you sure you want to delete this Penyakit?");
            if (userChoice) {
