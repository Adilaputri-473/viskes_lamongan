        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Table Indikator KIA</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Indikator KIA</a></li>
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header d-flex align-items-center"
                            ...
                            <h3 class="card-title">Table Indikator KIA</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <button type="button" class="btn btn-block btn-success" style="width:200px; border-radius: 8px;"
                                onclick="window.location.href='{{ url('add_ibu_anak') }}'">
                                <i class="fas fa-plus" style="padding-right: 8px;"></i> Add Indikator KIA
                            </button>
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @foreach ($ibu_anak as $data)
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td>{{ $data->indikator }}</td>
                                                <td class="text-right py-0 align-middle">
                                                    <div class="btn-group btn-group-sm">
                                                        <a href="{{ url('update_ibu_anak', $data->id) }}"
                                                            class="btn btn-info " style="border-radius: 8px;" title="Edit">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <a href="{{ url('delete_ibu_anak', $data->id) }}"
                                                            class="btn btn-danger" title="Delete style="border-radius: 80px; margin-left: 8px;"
                            ...
                            <div class="form-footer clearfix">
                                {{ $ibu_anak->appends(request()->input())->links('pagination::bootstrap-4') }}
                            </div>
                        </div>
                        <!-- /.card-body -->
