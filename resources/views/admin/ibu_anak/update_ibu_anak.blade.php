    ...
    <div class="content-wrapper" style="margin-bottom: 50px; background-color: #f6f6f6;">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Form Indikatir KIA</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Indikatir KIA</a></li>
            ...
            <div class="container-fluid">
                <div class="card card-default">
                    <div class="card-header d-flex align-items-center" style="background-color: #16b3ac; color: white; height: 70px">
                        <h3 class="card-title">Form Indikatir KIA</h3>
                    </div>
                    <form action="{{ url('edit_ibu_anak', $data->id) }}" method="Post" enctype="multipart/form-data">
                           ...
                           <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="indikator">Indikatir KIA</label>
                            ...
                            <div class="form-footer">
                                <input class="btn btn-primary" type="submit" style="border-radius: 8px;" value="Edit Indikatir KIA">
                        </div>
                        </div>
