                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Kesehatan Ibu & Anak</a></li>
            ...
            <section class="content" >
                <div class="container-fluid">
                    <div class="card card-default">
                        ...
                        <form action="{{ url('upload_kesehatan_ibu_anak') }}" method="Post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-footer ">
                                  <input class="btn btn-primary" type="submit" style="border-radius: 8px; width: 200px;" value="Add KIA" >
                                </div>
                            </div>
