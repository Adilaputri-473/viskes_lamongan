        ...
        <div class="content-wrapper" style="margin-bottom: 50px; background-color: #f6f6f6;">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Form Visualisasi Kesehatan Ibu & Anak</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Visualisasi Kesehatan Ibu & Anak</a></li>
                ...
                <div class="container-fluid">
                    <div class="card card-default">
                        <div class="card-header d-flex align-items-center"
                            ...
                            <h3 class="card-title">Form Visualisasi Kesehatan Ibu & Anak</h3>
                        </div>
                        <form action="{{ url('upload_visualisasi_kesehatan_ibu_anak') }}" method="Post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="indikator_id" style="width: 100%;">
                                            @foreach ($ibu_anaks as $ibu_anak)
                                                <option value="{{ $ibu_anak->id }}">{{ $ibu_anak->indikator }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
