    ...
    <div class="content-wrapper" style="margin-bottom: 50px; background-color: #f6f6f6;">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Form Topik Kesehatan</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
            ...
            <div class="container-fluid">
                <div class="card card-default">
                    <div class="card-header d-flex align-items-center" style="background-color: #17a2b8; color: white; height: 70px" >
                        <h3 class="card-title">Form Topik Kesehatan</h3>
                    </div>
                    <form action="{{ url('edit_topik_kesehatan', $data->id) }}" method="Post" enctype="multipart/form-data">
                           ...
                           <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="topik_kesehatan">Nama Topik Kesehatan</label>
                                        <input type="text" name="topik_kesehatan" class="form-control"
                                            value="{{ $data->topik_kesehatan }}" required>
                                    </div>
                                </div>
                            </div>
                            <!-- /.row -->
                            <div class="form-footer">
                                <input class="btn btn-primary" type="submit" value="Edit Topik Kesehatan">
                            </div>
                        </div>
