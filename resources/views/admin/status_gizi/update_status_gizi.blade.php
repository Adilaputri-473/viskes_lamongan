    ...
    <div class="content-wrapper" style="margin-bottom: 50px; background-color: #f6f6f6;">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Form Status Gizi</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
            ...
            <div class="container-fluid">
                <div class="card card-default">
                    <div class="card-header d-flex align-items-center"
                        ...
                        <h3 class="card-title">Form Status Gizi</h3>
                    </div>
                    <form action="{{ url('edit_status_gizi', $data->id) }}" method="Post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                           ...
                           <div class="col-md-6">
                            ...
                            <div class="form-footer ">
                                  <input class="btn btn-primary" type="submit" style="border-radius: 8px; width: 200px;" value="Edit Status Gizi" >
                            </div>
                        </div>
