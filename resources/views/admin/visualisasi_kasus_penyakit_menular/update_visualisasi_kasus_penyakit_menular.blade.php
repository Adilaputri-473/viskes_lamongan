    ...
    <div class="content-wrapper" style="margin-bottom: 50px; background-color: #f6f6f6;">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Form Visualisasi Kasus Penyakit</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Visualisasi Kasus Penyakit Menular</a></li>
            ...
            <div class="container-fluid">
                <div class="card card-default">
                    <div class="card-header d-flex align-items-center"
                        ...
                        <h3 class="card-title">Form Visualisasi Kasus Penyakit</h3>
                    </div>
                    <form action="{{ url('edit_visualisasi_kasus_penyakit_menular', $data->id) }}" method="Post" enctype="multipart/form-data">
                           ...
                           <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="indikator_id" style="width: 100%;">
                                            @foreach ($penyakit_menulars as $penyakit_menular)
                                                <option value="{{ $penyakit_menular->id }}"
                                                    {{ $penyakit_menular->id == $data->indikator_id ? 'selected' : '' }}>
                                                    {{ $penyakit_menular->indikator }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="link_visualisasi" class="form-control"
                                            value="{{ $data->link_visualisasi }}" required>
                                    </div>
                                </div>
                            </div>
                            <!-- /.row -->
                            <div class="form-footer ">
                                  <input class="btn btn-primary" type="submit" style="border-radius: 8px;" value="Edit Visualisasi Kasus Penyakit" >
                            </div>
                        </div>
