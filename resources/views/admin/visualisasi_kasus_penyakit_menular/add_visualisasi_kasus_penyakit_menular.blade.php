            ...
            <section class="content" >
                <div class="container-fluid">
                    <div class="card card-default">
                        ...
                        <form action="{{ url('upload_visualisasi_kasus_penyakit_menular') }}" method="Post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="indikator_id" style="width: 100%;">
                                            @foreach ($penyakit_menulars as $penyakit_menular)
                                                <option value="{{ $penyakit_menular->id }}">{{ $penyakit_menular->indikator }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
        ...
        <select name="kategori" class="form-control" required>
            ...
            <option value="peta">Peta</option>
                                ...
                                <div class="form-footer ">
                                  <input class="btn btn-primary" type="submit" style="border-radius: 8px; width: 200px;" value="Add Visualisasi">
                                </div>
                            </div>
