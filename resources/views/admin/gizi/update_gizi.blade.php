        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card card-default">
                    ...
                    <form action="{{ url('edit_gizi', $data->id) }}" method="Post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                           <div class="row">
                            ...
                            <div class="form-footer">
                                <input class="btn btn-primary" type="submit" style="border-radius: 8px;" value="Edit Indikatir Gizi">
                        </div>
                        </div>
